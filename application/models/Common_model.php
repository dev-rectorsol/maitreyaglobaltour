...
function updateUserId($data, $email, $table){
    ...
    function select_all_data($id,$table){
        $this->db->select('*');
        $this->db->from($table);
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    function select_single_row($table){
        $this->db->select('*');
        $this->db->from($table);
        $query = $this->db->get();
        $query = $query->row_array();
    ...
    function hide($id,$data,$table)
    {
        $this->db->update($table, $data);
        $this->db->where('status', $data);
        return true;
    }
    function show($id,$data,$table)
    {
        $this->db->update($table, $data);
        $this->db->where('status', $data);
        return true;
    ...
    function selectEnquiryList(){
        $this->db->select('enquiry.id,enquiry.firstName,enquiry.lastName,enquiry.email,enquiry.phone,enquiry.message,enquiry.tourId,enquiry.createdDate,tour.title as tourName');
        $this->db->from('enquiry');
        $this->db->join('tour', 'enquiry.tourId = tour.id');
        $query = $this->db->get();
        $query = $query->result_array();
        return $query;
    }
    function decline($id,$data,$table)
    {
        // print_r($id); exit();
        $this->db->where('id', $id);
        $this->db->update($table, $data);
    ...
    // Update contact data of admin
    function updateContact($data, $table){
        $this->db->update($table,$data);
        return true;
    }
}
